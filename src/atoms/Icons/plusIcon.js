...
import { StyledPlus, StyledFailureCircle, StyledPolyline } from './styled'

class PlusIcon extends React.Component {
    render() {
        return (
            <StyledPlus version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="20px" height="20px" viewBox="0 0 328.911 328.911">
                <g>
                    <g>
